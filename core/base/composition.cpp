...
std::unique_ptr<IMultiVector> apply_inner_operators(
...
template <typename ValueType>
void Composition<ValueType>::apply_impl(const IMultiVector* b,
...
template <typename ValueType>
void Composition<ValueType>::apply_impl(const IMultiVector* alpha,
...
#define GKO_DECLARE_COMPOSITION(ValueType) class Composition<ValueType>
