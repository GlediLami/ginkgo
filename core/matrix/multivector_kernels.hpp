...
#define GKO_DECLARE_MULTIVECTOR_FILL_KERNEL(ValueType)     \
    void fill(std::shared_ptr<const DefaultExecutor> exec, \
              matrix::view::dense<ValueType> mat, ValueType value)

#define GKO_DECLARE_MULTIVECTOR_SCALE_KERNEL(ValueType, ScalarType) \
    void scale(std::shared_ptr<const DefaultExecutor> exec,         \
               matrix::view::dense<const ScalarType> alpha,         \
               matrix::view::dense<ValueType> x)

#define GKO_DECLARE_MULTIVECTOR_INV_SCALE_KERNEL(ValueType, ScalarType) \
    void inv_scale(std::shared_ptr<const DefaultExecutor> exec,         \
                   matrix::view::dense<const ScalarType> alpha,         \
                   matrix::view::dense<ValueType> x)

#define GKO_DECLARE_MULTIVECTOR_ADD_SCALED_KERNEL(ValueType, ScalarType) \
    void add_scaled(std::shared_ptr<const DefaultExecutor> exec,         \
                    matrix::view::dense<const ScalarType> alpha,         \
                    matrix::view::dense<const ValueType> x,              \
                    matrix::view::dense<ValueType> y)

#define GKO_DECLARE_MULTIVECTOR_SUB_SCALED_KERNEL(ValueType, ScalarType) \
...
#define GKO_DECLARE_MULTIVECTOR_COMPUTE_DOT_KERNEL(ValueType)     \
    void compute_dot(std::shared_ptr<const DefaultExecutor> exec, \
                     matrix::view::dense<const ValueType> x,      \
                     matrix::view::dense<const ValueType> y,      \
                     matrix::view::dense<ValueType> result, array<char>& tmp)

#define GKO_DECLARE_MULTIVECTOR_COMPUTE_CONJ_DOT_DISPATCH_KERNEL(ValueType) \
...
#define GKO_DECLARE_MULTIVECTOR_COMPUTE_CONJ_DOT_KERNEL(ValueType)     \
...
#define GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM2_KERNEL(ValueType)               \
    void compute_norm2(std::shared_ptr<const DefaultExecutor> exec,           \
                       matrix::view::dense<const ValueType> x,                \
                       matrix::view::dense<remove_complex<ValueType>> result, \
                       array<char>& tmp)

#define GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM2_DISPATCH_KERNEL(ValueType) \
...
#define GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM1_KERNEL(ValueType)               \
    void compute_norm1(std::shared_ptr<const DefaultExecutor> exec,           \
                       matrix::view::dense<const ValueType> x,                \
                       matrix::view::dense<remove_complex<ValueType>> result, \
                       array<char>& tmp)

#define GKO_DECLARE_MULTIVECTOR_COMPUTE_MEAN_KERNEL(ValueType)     \
    void compute_mean(std::shared_ptr<const DefaultExecutor> exec, \
                      matrix::view::dense<const ValueType> x,      \
                      matrix::view::dense<ValueType> result, array<char>& tmp)

#define GKO_DECLARE_MULTIVECTOR_FILL_IN_MATRIX_DATA_KERNEL(ValueType, _prec)   \
    void fill_in_matrix_data(std::shared_ptr<const DefaultExecutor> exec,      \
                             const device_matrix_data<ValueType, _prec>& data, \
                             matrix::view::dense<ValueType> output)

#define GKO_DECLARE_MULTIVECTOR_COMPUTE_SQUARED_NORM2_KERNEL(ValueType) \
...
#define GKO_DECLARE_MULTIVECTOR_COMPUTE_SQRT_KERNEL(ValueType)     \
...
#define GKO_DECLARE_MULTIVECTOR_CONJ_TRANSPOSE_KERNEL(ValueType)     \
    void conj_transpose(std::shared_ptr<const DefaultExecutor> exec, \
                        matrix::view::dense<const ValueType> orig,   \
                        matrix::view::dense<ValueType> trans)

#define GKO_DECLARE_MULTIVECTOR_SYMM_SCALE_PERMUTE_KERNEL(ValueType,     \
                                                          IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_ROW_SCALE_PERMUTE_KERNEL(ValueType, IndexType) \
...
#define GKO_DECLARE_MULTIVECTOR_COL_SCALE_PERMUTE_KERNEL(ValueType, IndexType) \
...
#define GKO_DECLARE_MULTIVECTOR_INV_SYMM_SCALE_PERMUTE_KERNEL(ValueType,     \
                                                              IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_INV_ROW_SCALE_PERMUTE_KERNEL(ValueType,     \
                                                             IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_INV_COL_SCALE_PERMUTE_KERNEL(ValueType,     \
                                                             IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_NONSYMM_SCALE_PERMUTE_KERNEL(ValueType,     \
                                                             IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_INV_NONSYMM_SCALE_PERMUTE_KERNEL(ValueType,   \
                                                                 IndexType)   \
...
#define GKO_DECLARE_MULTIVECTOR_SYMM_PERMUTE_KERNEL(ValueType, IndexType) \
    void symm_permute(std::shared_ptr<const DefaultExecutor> exec,        \
                      const IndexType* permutation_indices,               \
                      matrix::view::dense<const ValueType> orig,          \
                      matrix::view::dense<ValueType> permuted)

#define GKO_DECLARE_MULTIVECTOR_INV_SYMM_PERMUTE_KERNEL(ValueType, IndexType) \
    void inv_symm_permute(std::shared_ptr<const DefaultExecutor> exec,        \
                          const IndexType* permutation_indices,               \
                          matrix::view::dense<const ValueType> orig,          \
                          matrix::view::dense<ValueType> permuted)

#define GKO_DECLARE_MULTIVECTOR_NONSYMM_PERMUTE_KERNEL(ValueType, IndexType) \
...
#define GKO_DECLARE_MULTIVECTOR_INV_NONSYMM_PERMUTE_KERNEL(ValueType,     \
                                                           IndexType)     \
...
#define GKO_DECLARE_MULTIVECTOR_ROW_GATHER_KERNEL(ValueType, OutputType, \
                                                  IndexType)             \
...
#define GKO_DECLARE_MULTIVECTOR_ADVANCED_ROW_GATHER_KERNEL(               \
...
#define GKO_DECLARE_MULTIVECTOR_COL_PERMUTE_KERNEL(ValueType, IndexType) \
    void col_permute(std::shared_ptr<const DefaultExecutor> exec,        \
                     const IndexType* permutation_indices,               \
                     matrix::view::dense<const ValueType> orig,          \
                     matrix::view::dense<ValueType> col_permuted)

#define GKO_DECLARE_MULTIVECTOR_INV_ROW_PERMUTE_KERNEL(ValueType, IndexType) \
    void inv_row_permute(std::shared_ptr<const DefaultExecutor> exec,        \
                         const IndexType* permutation_indices,               \
                         matrix::view::dense<const ValueType> orig,          \
                         matrix::view::dense<ValueType> row_permuted)

#define GKO_DECLARE_MULTIVECTOR_INV_COL_PERMUTE_KERNEL(ValueType, IndexType) \
...
#define GKO_DECLARE_ALL_AS_TEMPLATES                                          \
    ...
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_FILL_KERNEL(ValueType);                           \
    template <typename ValueType, typename ScalarType>                        \
    GKO_DECLARE_MULTIVECTOR_SCALE_KERNEL(ValueType, ScalarType);              \
    template <typename ValueType, typename ScalarType>                        \
    GKO_DECLARE_MULTIVECTOR_INV_SCALE_KERNEL(ValueType, ScalarType);          \
    template <typename ValueType, typename ScalarType>                        \
    ...
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_DOT_DISPATCH_KERNEL(ValueType);           \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_CONJ_DOT_KERNEL(ValueType);               \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_CONJ_DOT_DISPATCH_KERNEL(ValueType);      \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM2_KERNEL(ValueType);                  \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM2_DISPATCH_KERNEL(ValueType);         \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_NORM1_KERNEL(ValueType);                  \
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_COMPUTE_MEAN_KERNEL(ValueType);                   \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_FILL_IN_MATRIX_DATA_KERNEL(ValueType, IndexType); \
    template <typename ValueType>                                             \
    ...
    template <typename ValueType>                                             \
    GKO_DECLARE_MULTIVECTOR_CONJ_TRANSPOSE_KERNEL(ValueType);                 \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_SYMM_PERMUTE_KERNEL(ValueType, IndexType);        \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_SYMM_PERMUTE_KERNEL(ValueType, IndexType);    \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_NONSYMM_PERMUTE_KERNEL(ValueType, IndexType);     \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_NONSYMM_PERMUTE_KERNEL(ValueType, IndexType); \
    template <typename ValueType, typename OutputType, typename IndexType>    \
    GKO_DECLARE_MULTIVECTOR_ROW_GATHER_KERNEL(ValueType, OutputType,          \
                                              IndexType);                     \
    template <typename ValueType, typename OutputType, typename IndexType>    \
    GKO_DECLARE_MULTIVECTOR_ADVANCED_ROW_GATHER_KERNEL(ValueType, OutputType, \
                                                       IndexType);            \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_COL_PERMUTE_KERNEL(ValueType, IndexType);         \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_ROW_PERMUTE_KERNEL(ValueType, IndexType);     \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_COL_PERMUTE_KERNEL(ValueType, IndexType);     \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_SYMM_SCALE_PERMUTE_KERNEL(ValueType, IndexType);  \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_SYMM_SCALE_PERMUTE_KERNEL(ValueType,          \
                                                          IndexType);         \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_ROW_SCALE_PERMUTE_KERNEL(ValueType, IndexType);   \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_COL_SCALE_PERMUTE_KERNEL(ValueType, IndexType);   \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_ROW_SCALE_PERMUTE_KERNEL(ValueType,           \
                                                         IndexType);          \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_INV_COL_SCALE_PERMUTE_KERNEL(ValueType,           \
                                                         IndexType);          \
    template <typename ValueType, typename IndexType>                         \
    GKO_DECLARE_MULTIVECTOR_NONSYMM_SCALE_PERMUTE_KERNEL(ValueType,           \
                                                         IndexType);          \
    template <typename ValueType, typename IndexType>                         \
