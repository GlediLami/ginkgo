...
template <typename ValueType>
void Gcr<ValueType>::apply_impl(const IMultiVector* b, IMultiVector* x) const
{
...
template <typename ValueType>
void Gcr<ValueType>::apply_impl(const IMultiVector* alpha,
...
#define GKO_DECLARE_GCR(ValueType) class Gcr<ValueType>
#define GKO_DECLARE_GCR_TRAITS(ValueType) \
