...
protected:
     ...
     */
    virtual void apply_with_initial_guess(const IMultiVector* b,
                                          IMultiVector* x,
                                          initial_guess_mode guess) const = 0;

    void apply_with_initial_guess(ptr_param<const IMultiVector> b,
     ...
     * @param guess  the input guess to handle the input vector(s)
     */
    virtual void apply_with_initial_guess(const IMultiVector* alpha,
    ...
    void apply_with_initial_guess(ptr_param<const IMultiVector> alpha,
...
protected:
     ...
     *          initial_guess_mode)
     */
    void apply_with_initial_guess(const IMultiVector* b, IMultiVector* x,
     ...
     */
    void apply_with_initial_guess(const IMultiVector* alpha,
                                  const IMultiVector* b,
...
public:
    ...
    const IMultiVector* get_workspace_op(int vector_id) const
    {
...
protected:
    ...
    template <typename VectorType,
              typename =
                  std::enable_if_t<std::is_base_of_v<IMultiVector, VectorType>>>
